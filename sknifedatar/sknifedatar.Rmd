...
Se particiona el dataset en train y test
```{r, fig.height=3, fig.width=10}
splits <- data_hawaii %>%  
...
```
--
**Modelo**: Se especifica el modelo a ajustar
```{r}
autoarima_boost_reg = arima_boost() %>% 
  set_engine('auto_arima_xgboost') 
```
--
**Ajujste**: Se genera un workflow añadiendo la receta y luego el modelo. Finalmente, se entrena con los datos de entrenamiento
```{r}
wf <- workflow() %>% 
  add_recipe(receta) %>% 

...
Ajuste y visualización de múltiples modelos sobre múltiples series de tiempo. Se presentarán varios casos de uso mostrando como modelar series de tiempo con tidymodels y modeltime a través de la extensión sknifedatar.
...
🚀 **Data Scientist**
- Actuario 🇻🇪
- Especialista en métodos cuantitativos (magister en curso)
]
.pull-right[
<br>
<br>
...
knitr::include_graphics('https://media3.giphy.com/media/UotLuplZSzKRa/giphy.gif?cid=790b761126fdbc23cdef84ed3d243a31b042ccc0e3dc8b28&rid=giphy.gif&ct=g')
```
...
knitr::include_graphics('https://media1.tenor.com/images/de33de657684710f3b742a2e5e7f5020/tenor.gif?itemid=4409990')
```
...
```{r, echo=FALSE, out.width='30%', fig.align='center'}
knitr::include_graphics('https://media1.tenor.com/images/4ded3e63cdeb091e55a9e91b1ceb2340/tenor.gif?itemid=5002827')
```
...
<br>
```{r, out.width='50%', fig.align='center', echo=FALSE}
knitr::include_graphics('https://media.tenor.com/images/23bfa35425bcd3794bea802adb5b9bfc/tenor.gif')
```

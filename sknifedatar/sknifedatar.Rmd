...
---
### Calibración de modelos: Se everifica el rendimiento de los modelos sobre la partición de test.
...
### Se everifica el rendimiento de los modelos sobre la partición de test.
...
Se seleccionan el mejor modelo para cada serie en función a una métrica.
